...
function replaceFunction(code, funcSignature, newFuncCode) {
    ...
    // add 1 to endIdx to include the '}'
...
code = replaceFunction(code, 'window.openMenuModal = function() {', newMenuModalStr);
code = replaceFunction(code, 'window.openBackupModal = function() {', newBackupModalStr);
code = replaceFunction(code, 'window.openThemeModal = function() {', newThemeModalStr);
